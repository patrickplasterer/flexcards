    ...
    return (
            <div className="flex flex-col flex-grow overflow-hidden w-[20vw]">
                <div className="flex h-[3vh] flex-none items-center justify-center">
                    <div className={cn('flex w-full items-center justify-end gap-1 text-sm p-2', {'hidden': workspace === 'study'})}>
                        <DeleteDeckDialog handleClick={handleDelete}/>
                        <UpdateDeckDialog handleClick={handleUpdate} activeDeck={deck}/>
