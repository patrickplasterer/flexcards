...
export default function Page() {
    return (
        <div className="flex flex-col h-dvh w-full p-6 overflow-auto">
            <div className="flex flex-col text-9xl md:text-[8rem] font-black leading-none mb-8">Discover new decks</div>
            <div className="flex flex-col text-6xl md:text-8xl leading-none">
                <div className="mb-6 leading-tight"><Link href='./discover/browser' className="inline-flex flex-col items-center justify-center underline underline-offset-[1rem] hover:bg-highlighter hover:text-black hover:bg-amber-600">Discover all</Link> decks or browse by topic:</div>
            </div>
