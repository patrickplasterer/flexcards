...
export default function Page() {
    return (
        <div className="flex flex-col h-dvh w-full p-6 overflow-auto">
            <div className="flex flex-col text-9xl md:text-[8rem] font-black leading-none mb-8">Let's learn something.</div>
            <div className="flex flex-col text-6xl md:text-8xl leading-none">
                <div className="mb-6 leading-tight">
                    <Link href='./discover/browser' className="inline-flex flex-col items-center justify-center underline underline-offset-[1.5rem] hover:bg-highlighter hover:text-black hover:bg-amber-600">Study your decks</Link>, 
                    <Link href='./discover/browser' className="inline-flex flex-col items-center justify-center underline underline-offset-[1.5rem] hover:bg-highlighter hover:text-black hover:bg-amber-600">edit them</Link>,  
