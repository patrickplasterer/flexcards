        ...
        <div className="flex flex-col h-dvh w-full p-12 overflow-auto">
            ...
            <div className="flex flex-col text-6xl md:text-8xl leading-none">
                <div className="mb-6 leading-snug">
                    ...
                    <Link href='/discover/browser' className="inline-flex p-1 flex-col items-center justify-center underline underline-offset-[1.5rem] hover:bg-highlighter hover:text-black hover:bg-amber-600">discover all</Link> or browse by topic:</div>
            </div>
